        ...
        Box(
            modifier =
                Modifier.onKeyEvent {
                    ...
                    if (it.key in numKeyMaps.keys) {
                        displayNumber = displayNumber.addDigit(numKeyMaps[it.key]!!, inputState)
                        true
                    } else {
                        false
                    }
